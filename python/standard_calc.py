...
def is_angle_between(first_angle, middle_angle, second_angle):
    ...
    first_second_difference: float = abs((first_angle - second_angle + 180) % 360 - 180)
    middle_first_difference: float = abs((first_angle - middle_angle + 180) % 360 - 180)
    middle_second_difference: float = abs((second_angle - middle_angle + 180) % 360 - 180)

    # the magnitude of angle between first and second must be greater than the magnitude betwen middle and second and first.
    return first_second_difference > middle_second_difference and first_second_difference > middle_first_difference
